...
```bash
git clone https://github.com/hcfdc/Lumina.git
cd Lumina
```
...
- `ghcr.io/hcfdc/lumina-backend:latest` - Backend (Node.js + Express)
- `ghcr.io/hcfdc/lumina-frontend:latest` - Frontend (React + Nginx)
